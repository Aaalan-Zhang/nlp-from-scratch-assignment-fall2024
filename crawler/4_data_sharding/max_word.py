...
def split_chunk_by_words(text, max_words_per_chunk=MAX_WORDS_PER_CHUNK):
...
input_directory = '../../data/crawled/crawled_text_data_append_sharding_3072_600'  # Directory containing text files
output_directory = f'../../data/crawled/crawled_text_data_append_sharding_3072_600_max_{MAX_WORDS_PER_CHUNK}'  # Directory to save the shards
