...
if __name__ == "__main__":
    ...
    file_path = '../../data/crawled/crawled_sublinks_original.csv'
    data = pd.read_csv(file_path)

    # Extract non-empty URLs from the 'Source URL' column
    urls = data['Sublink'].dropna().unique()

    output_csv = '../../data/crawled/sublink_file_name_url_mapping.csv'
    ...
    # Remove duplicates
    remove_duplicate_urls(output_csv, column_name)